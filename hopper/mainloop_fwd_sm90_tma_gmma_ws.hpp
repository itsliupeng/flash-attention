    ...
    struct CollectiveMainloopFwd
    {
        ...
        struct Params
        {
            ...
            void print() const
            {
                ...
                cute::print(layout_V);
                cute::print("\n"); // (128,256,16,8):(4096,_1,256,524288)
                cute::print("\t tma_load_Q: ");
                cute::print(tma_load_Q);
                cute::print("\n");
                cute::print("\t tma_load_K: ");
                cute::print(tma_load_K);
                cute::print("\n");
                cute::print("\t tma_load_V: ");
                cute::print(tma_load_V);
                cute::print("\n");
                cute::print("\t block_table: ");
                cute::print(block_table);
                cute::print("\n");
                cute::print("\t block_table_batch_stride: ");
                cute::print(block_table_batch_stride);
                cute::print("\n");
                cute::print("\t page_size: ");
                cute::print(page_size);
                cute::print("\n");
                cute::print("\t page_stride: ");
                cute::print(page_stride);
                cute::print("\n");
                cute::print("\t row_stride: ");
                cute::print(row_stride);
                cute::print("\n");
                cute::print("\t multiprocessor_count: ");
                cute::print(multiprocessor_count);
                cute::print("\n");
                cute::print("<<<<< in CollectiveMainloopFwd#Params\n");
            };
...
#pragma unroll 2
                 ...
                 int n_block_max)
        {
            ...
            if (thread0())
            {
                print("seqlen_traits_k: ");
                print(seqlen_traits_k.actual_seq_len);
                print("\n");
                print("tma_load_K_page_ptr: ");
                print(tma_load_K_page_ptr);
                print("\n");
                print("tma_load_K_desc_ptr: ");
                print(tma_load_K_desc_ptr);
                print("\n");
                print("sQ: ");
                print(sQ);
            ...
            else
            {
                ...
                if (warp_idx_in_warpgroup == 0 && lane_predicate)
                {
                    if (is_page_cache)
                    {
                        ...
                        {
                            PRINT_DEBUG_SITE();
                            print("update tma_load_K_desc_ptr n_block: ");
                            print(n_block);
                            print("\n");
                            print("update tma_load_K_desc_ptr kBlockN: ");
                            print(kBlockN);
                            print("\n");
                            print("update tma_load_K_desc_ptr page_size: ");
                            print(page_size);
                            print("\n");
                            print("update tma_load_K_desc_ptr page_stride: ");
                            print(page_stride);
                            print("\n");
                            print("update tma_load_K_desc_ptr ptr_K: ");
                            print(ptr_K);
                            print("\n");
                            print("update tma_load_K_desc_ptr global_offset: ");
                            print(global_offset);
                            print("\n");
                            print("update tma_load_K_desc_ptr ptr_K + global_offset: ");
                            print(ptr_K + global_offset);
                            print("\n");
                        }
#endif
                    }
...
#pragma unroll
                for (int i = 0; i < size(tSrS); ++i)
                {
                    ...
                    { // mask based on both row and col
