...
__forceinline__ __device__ int64_t resolve_page_slice_offset(const int* block_table, const int n_block, const int kBlockN, const int page_size, const int page_stride, const int row_stride) {
